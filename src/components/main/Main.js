        ...
        <main>
            ...
            <section className={classes["main-introduce"]}>
                ...
                <div className={classes["intro-menu-container"]}>
                    <Link to='/resume'><button className={classes["intro-menu1"]}>Resume</button></Link>
                    <Link to='/projects'><button className={classes["intro-menu2"]}>Projects</button></Link>
                    <Link to='/contact'><button className={classes["intro-menu3"]}>Contact</button></Link>
                </div>
            </section>
        </main>
    );
